      ...
      <div className="max-w-xl mx-auto">
        <div className="text-center mb-8">
          <div className="size-14 rounded-full bg-[#1e3a5f]/8 flex items-center justify-center mx-auto mb-4">
            <Store className="size-6 text-[#1e3a5f]" />
          </div>
          <h1 className="text-xl font-bold text-[#1e3a5f]">Cadastro de artesão</h1>
          <p className="text-sm text-neutral-500 mt-1">Enviado em {formatDate(artisan.createdAt)}</p>
        </div>

        <div className="bg-white rounded-2xl border border-[#1e3a5f]/10 p-5 mb-5">
          <table className="w-full text-sm">
            <tbody>
              <tr><td className="py-1.5 text-neutral-400 w-28 align-top">Loja</td><td className="py-1.5 font-semibold text-[#1e3a5f]">{artisan.storeName}</td></tr>
          ...
          <div className="bg-white rounded-2xl border border-neutral-100 p-5 text-center">
            {artisan.status === "APPROVED" ? (
              <>
                ...
                <p className="text-sm font-semibold text-[#27ae60]">Este cadastro já foi aprovado</p>
              </>
